...
<div id="main">
    ...
    <div class="row" style="max-width: 100%;">
        ...
        <div class="col-md-4" style="margin: 0px; padding: 0;">
            <center>
                <button class="btn btn-danger btn-sm" style="margin: 0; ">End Exam</button>
            </center>
        </div>
    </div>
    ...
    <div class="container" style="border: ridge; border-radius: 15px;"><br>
        <span>
            <center>
                ...
                Time Remaining :- 1 min 20 sec
            </center>
        </span>
        <div class="progress">
            <div class="progress-bar" role="progressbar" style="width: 100%; color: black;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div><br>
        </div>
